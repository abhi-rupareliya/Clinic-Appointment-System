...
const Footer = () => {
  ...
  return (
    <>
      <svg
        className='-mt-16 md:-mt-24 lg:-mt-40 xl:-mt-44 absolute overflow-hidden'
      ...
      >
        <path
          fill='#4f46e5'
          fill-opacity='1'
          d='M0,64L80,80C160,96,320,128,480,122.7C640,117,800,75,960,74.7C1120,75,1280,117,1360,138.7L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z'
        ></path>
      </svg>
      ...
      <footer className='bg-gradient-to-b from-[#4f46e5] to-purple-500 p-12 absolute w-full'>
        <div className='mx-auto flex-col lg:w-5/6 lg:grid lg:grid-cols-2 lg:gap-5 flex items-center justify-center'>
          <div className='p-10'>
            ...
            <hr className='mt-5' />
            <h6 className='font-bold mt-5 text-xl text-white col-span-2 mb-3 text-center lg:text-left'>
              Follow us
            </h6>
            <div className='flex mt-4 gap-6 sm:mt-0 justify-center sm:justify-start'>
              <a
                href='https://www.facebook.com/'
                className='text-gray-50 hover:text-gray-900'
              >
                <svg
                  className='w-5 h-5'
                  fill='currentColor'
          ...
          <div className='grid grid-cols-1 gap-1 p-7 col-span-1'>
            <h6 className='font-bold text-2xl text-center lg:text-left text-white col-span-1 mb-3'>
              Quick Links
            </h6>
